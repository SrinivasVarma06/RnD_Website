      ...
      <div className="p-4 bg-gray-50 border-t border-gray-100 space-y-1">
        {email && (
          <div className="flex items-center text-sm text-gray-700">
            ...
            <a href={`mailto:${email}`} className="text-purple-600 underline hover:text-purple-800 truncate">
              {email}
            </a>
          </div>
        )}
        ...
        {website && (
          <div className="flex items-center text-sm text-gray-700">
            ...
            <a href={website} target="_blank" rel="noopener noreferrer" className="text-purple-600 underline hover:text-purple-800 truncate">
              Website
            </a>
          </div>
        )}
      ...
      <div className="p-4 bg-gray-50 text-sm flex-grow">
        {email && (
          <div className="flex items-center mb-2">
            ...
            <a href={`mailto:${email}`} className="text-purple-600 underline hover:text-purple-800 truncate">{email}</a>
          </div>
        )}
      </div>
    </div>
