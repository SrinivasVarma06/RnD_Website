...
export default function Fellowship() {
    ...
    const processedData = useMemo(() => {
        ...
        if (search) {
            ...
            filtered = filtered.filter(item => {
                const name = item.name || item.Name || '';
                const title = item.project_title || item.title || '';
                return [name, title].join(" ").toLowerCase().includes(searchLower);
            });
        }
        if (statusFilter !== 'all') {
            filtered = filtered.filter(item => {
    ...
    return (
        <div className="max-w-[95%] mx-auto p-4" id="fellowship-top">
            <div className="text-center mb-8">
                ...
                <p className="text-gray-600 mt-3 text-base md:text-lg">Research fellowships and individual grants</p>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-5">
                    <p className="text-base md:text-lg text-gray-600 font-medium">Total Fellowships</p>
            ...
            <div className="relative mb-4">
                ...
                <input type="text" placeholder="Search by name or title..." value={search} onChange={(e) => setSearch(e.target.value)}
            ...
            <div className="flex items-center justify-between mb-4">
                <p className="text-sm text-gray-600">Showing {processedData.length} of {info.length} fellowships</p>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {paginatedData.length === 0 ? (
                            <tr><td colSpan={displayColumns.length + 1} className="px-4 py-8 text-center text-gray-500">No fellowships found</td></tr>
